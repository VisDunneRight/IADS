import {
  Content_default,
  dist_default
} from "./chunk-FHUDVMQI.js";
import "./chunk-EX5BY7X7.js";
import {
  dist_default as dist_default2
} from "./chunk-K7Z7YYWA.js";
import "./chunk-NQAADGPX.js";
import "./chunk-T6AHQBDX.js";
import "./chunk-FH6GA4EX.js";
...
function create_fragment2(ctx) {
  ...
  paper = new dist_default({ props: paper_props, $$inline: true });
  ctx[24](paper);
  paper.$on(
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      const paper_changes = dirty & /*usePass, classMap, className, open, opened, disabled, nonInteractive, variant, extend, extendedElevation, elevation, color, $$restProps*/
      69119 ? get_spread_update(paper_spread_levels, [
        ...
        dirty & /*classMap, className, open, opened, disabled, nonInteractive, variant, extend, extendedElevation, elevation*/
        1527 && {
          class: classMap({
            [
              /*className*/
...
var file2 = "node_modules\\@smui-extra\\accordion\\dist\\Header.svelte";
...
function create_if_block_2(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(div, file2, 30, 4, 672);
    },
    m: function mount(target, anchor) {
      insert_dev(target, div, anchor);
    },
...
function create_if_block_1(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(div, file2, 41, 4, 945);
    },
    m: function mount(target, anchor) {
      insert_dev(target, div, anchor);
      if (description_slot) {
...
function create_if_block(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(div, file2, 46, 4, 1073);
    },
    m: function mount(target, anchor) {
      insert_dev(target, div, anchor);
      if (icon_slot) {
...
function create_fragment3(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(div0, file2, 32, 2, 729);
    ...
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        dispose = [
          ...
          action_destroyer(Ripple_action = dist_default2.call(null, div1, {
            ripple: (
              /*ripple*/
              ctx[3]
            ),
